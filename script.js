...
function functionsection_visible() {
    ...
    var functionheader = document.getElementById("id_functionheader");
    ...
    if (functionheader.style.visibility == "hidden" || functionheader.style.display == "none") {
        ...
        functionheader.style.display = "block";
...
function process_display_section(transaction) {
    ...
    //alert('process_diplay_section succes. Response = '+transaction.responseText);
...
function failure_display_section() {
    callbackResult = false;
}
